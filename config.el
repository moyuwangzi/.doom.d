...
;; config of control the hidden element===============
(use-package! org-expose-emphasis-markers
  :after org
  :hook (org-mode . (lambda () (org-expose-emphasis-markers-mode t)))
  :config
  ;;(optional) set the exposing scope, default value is 'item
...
;; 加载自定义的 org-expose-link-markers 库
